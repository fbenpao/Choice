...
public class CartAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            ...
            vh.kucun=(TextView)view.findViewById(R.id.tv_goods_kucun);
        ...
        if(dataList.size()>0){
            ...
            vh.kucun.setText(map.get("kucun"));
            ...
            vh.add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    final int index=position;
                    dataList.get(index).put("count",(Integer.valueOf(dataList.get(index).get("count"))+1)+"");
                    if(Integer.valueOf(dataList.get(index).get("count"))>10){
                        //15为库存可选择上限
    ...
    class ViewHolder{
        CheckBox checkBox;
        ImageView icon;
        TextView name,kucun,num,reduce,add;
    }
}